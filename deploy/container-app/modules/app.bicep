...
@description('Set the Dapr app id for this container app, leave blank to disable Dapr')
param daprAppId string = ''

@description('Set the Dapr app port for this container app, leave blank to disable Dapr')
...
resource containerApp 'Microsoft.App/containerApps@2022-06-01-preview' = {
  ...
  properties: {
    ...
    configuration: {
      ...
      dapr: {
        enabled: daprAppId != '' && daprAppPort > 0
        appId: daprAppId != '' ? daprAppId : null
        appPort: daprAppPort > 0 ? daprAppPort : null
      }
    }
  }
}
